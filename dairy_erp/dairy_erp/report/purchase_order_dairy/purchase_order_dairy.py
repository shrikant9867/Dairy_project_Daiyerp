...
def get_conditions(filters):
	cond = ''
	if filters.get('camp_office') and filters.get('from_date') and filters.get('to_date') and filters.get('camp_office'):
	...
	if filters.get('camp_office') and filters.get('from_date') and filters.get('to_date'):
